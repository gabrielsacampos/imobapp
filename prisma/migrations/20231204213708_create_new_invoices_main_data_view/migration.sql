...
--create new invoices main data view

CREATE VIEW invoices_main_data AS
select (i.total_value*(o."share"/100)) as value, i.total_value as total_invoice_value, o."share", b."name" as building, p.unity, p.block, i.status, i.due_date,
case 
