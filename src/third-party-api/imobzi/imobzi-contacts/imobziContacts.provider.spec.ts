...
describe('ImobziContactsProvider -- access to third-party api data', () => {
  let imobziContactsProvider: ImobziContactsProvider;
  ...
  beforeEach(async () => {
    ...
    imobziContactsProvider = moduleRef.get<ImobziContactsProvider>(ImobziContactsProvider);
  ...
  test('getAllContacts', async () => {
    const result = await imobziContactsProvider.getAllContacts();
